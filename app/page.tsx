...
// Mapeamento completo das Skills com ícones e cores
const SKILLS = [
  { name: Skill.REACT, icon: FaReact, color: "text-blue-400" },
  ...
  { name: Skill.GITHUB, icon: FaGithub, color: "text-white" },
  ...
  { name: Skill.SQLALCHEMY, icon: SiSqlalchemy, color: "text-red-400" }, // Ou FaDatabase se preferir genérico
